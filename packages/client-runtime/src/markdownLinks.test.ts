...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    ["file:///D:/Programme/ito/OpenInPicker.tsx#L69", "D:/Programme/ito/OpenInPicker.tsx", "#L69"],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/ito/OpenInPicker.tsx", "D:/Programme/ito/OpenInPicker.tsx"],
    ["</D:/Programme/ito/ChatMarkdown.tsx:1>", "D:/Programme/ito/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\ito\\apps\\web\\a.ts", "C:/Users/mike/ito", "apps/web/a.ts"],
    ["/C:/Users/mike/ito/apps/web/a.ts", "C:/Users/mike/ito", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/ito/main.ts", "c:/users/MIKE/ito", "main.ts"],
    ["/C:/USERS/mike/ito/main.ts", "/c:/users/MIKE/ito", "main.ts"],
