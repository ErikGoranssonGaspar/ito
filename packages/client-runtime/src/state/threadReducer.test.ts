...
import type { OrchestrationThread } from "@ito/contracts";
...
describe("applyThreadDetailEvent", () => {
  ...
  describe("thread pull request links", () => {
    ...
    const key = { host: "github.com", repository: "pingdotgg/ito", number: 42 };
    ...
    it("keeps structured context on a newly sent message", () => {
      ...
      const result = applyThreadDetailEvent(baseThread, {
        ...
        payload: {
          ...
          role: "user",
          text: "Watch [demo.mp4](ito-context://v1/file/video-1).",
          context,
          turnId: null,
          streaming: false,
