import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@ito/contracts";
import { resolveRemotePairingTarget } from "@ito/shared/remote";
...
>()("@ito/client-runtime/connection/onboarding/ConnectionOnboarding") {}
