...
>()("@ito/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@ito/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@ito/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@ito/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
