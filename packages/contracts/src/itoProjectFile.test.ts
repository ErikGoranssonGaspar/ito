...
import { ItoProjectFile } from "./itoProjectFile.ts";

const decode = Schema.decodeUnknownSync(ItoProjectFile);

describe("ItoProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://github.com/ErikGoranssonGaspar/ito/blob/main/schema/ito.json",
