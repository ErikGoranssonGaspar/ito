import type { ThreadEnvMode } from "@ito/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in ito.json > global server setting.
 *
 ...
 * source that outranks ito.json decided, or the file read settled. While
