...
/**
 * Canonical inline reference: `[label](ito-context://v1/<kind>/<contextId>)`, or the image
...
const CONTEXT_PROTOCOL = "ito-context:";
...
export function collectComposerContextReferences(
  ...
  if (!text.includes("](ito-context:")) return occurrences;
...
const CONTEXT_ENVELOPE_TAG = "ito_context";
...
/**
 * Captured text is data. A terminal line or PR comment that contains `</ito_context>` or
