...
Each project uses `text.svg` for the Itô mark and `background.svg` when the background is a vector layer. Additional layers use semantic names that describe their role and placement.
...
- `prod/app-icon.icon` -> `prod/ito-macos-1024.png`
...
- assets/prod/app-icon.icon -> assets/prod/ito-macos-1024.png
