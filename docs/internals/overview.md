...
Keeping that logic shared keeps reconnect and multi-environment behavior in one place. See
[connection runtime](./connection-runtime.md).
...
A client and the environments it reaches upgrade independently. Negotiate linking through the
