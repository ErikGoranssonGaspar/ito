...
Terms whose meaning matters across Itô. Architecture and lifecycle constraints belong in the
...
| Itô home       | The base data directory. Runtime state normally lives under its `userdata` directory.           |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Itô controls, such as Codex or Claude Code.                                                |
...
| Adapter             | The boundary translating a provider's native protocol into Itô operations and events.                        |
...
| Context reference    | One occurrence of a record in message text: `[label](ito-context://v1/<kind>/<contextId>)`. Several references can share one record. |
