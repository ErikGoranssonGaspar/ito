...
This starts the Electron window and its local backend. The app keeps its state in the checkout's gitignored `.t3` directory. Preserve that directory to retain your threads and settings.
