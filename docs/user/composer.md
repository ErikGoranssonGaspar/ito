...
also send files to Itô through another app's system share sheet.
...
messages survive app restarts. Signing out of Itô keeps that work on your
...
Itô remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. Itô deletes the temporary audio after
...
Provider commands must start the message to run. Itô commands such as
...
complete Itô tells you and leaves the chip for you to remove or replace. A chip whose
...
automatically. HTML previews cannot access your Itô session.
