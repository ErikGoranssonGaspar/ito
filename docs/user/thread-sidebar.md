...
When you change a new thread's project, Itô stays in the current environment
...
If dragging is unavailable for one environment, update the Itô server running in that
