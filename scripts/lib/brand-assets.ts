export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/ito-ios-1024.png",
  productionMacIconPng: "assets/prod/ito-macos-1024.png",
  productionLinuxIconPng: "assets/prod/ito-universal-1024.png",
  productionWindowsIconIco: "assets/prod/ito-windows.ico",
  productionWebFaviconIco: "assets/prod/ito-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/ito-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/ito-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/ito-web-apple-touch-180.png",
