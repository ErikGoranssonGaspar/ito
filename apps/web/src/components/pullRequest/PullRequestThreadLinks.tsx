...
import type { EnvironmentId, PullRequestRef, ScopedThreadRef, ThreadId } from "@ito/contracts";
...
import { normalizeThreadPullRequestKey } from "@ito/shared/threadPullRequests";
