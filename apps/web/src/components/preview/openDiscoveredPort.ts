import type { DiscoveredLocalServer, ScopedThreadRef } from "@ito/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@ito/client-runtime/state/runtime";
