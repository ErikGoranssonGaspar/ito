...
import { filterComposerPullRequestMatches } from "@ito/shared/composerPullRequestMatches";
...
} from "@ito/client-runtime/text-paste";
import { serializeComposerFileLink } from "@ito/shared/composerTrigger";
import { folderDropTarget, resolveDroppedFolderPath } from "./folderDrop";
import { createModelSelection, normalizeModelSlug } from "@ito/shared/model";
import { USAGE_LIMITS_COMMAND } from "@ito/shared/usageLimits";
import {
  Fragment,
  memo,
  type ComponentProps,
...
} from "@ito/client-runtime/state/attachments";
import {
...
import { encodeComposerContextFragment } from "@ito/shared/composerContextClipboard";
import type { ComposerContextClipboardFragment, ComposerContextRecord } from "@ito/contracts";
...
import type { UnifiedSettings } from "@ito/contracts/settings";
import {
  isVideoAttachment,
  type ChatMessage,
  type SessionPhase,
...
} from "@ito/client-runtime/providerSkills";
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const onComposerPaste = (event: React.ClipboardEvent<HTMLElement>) => {
    ...
    // Copied Ito chips need the structured importer to bring their records and files along.
