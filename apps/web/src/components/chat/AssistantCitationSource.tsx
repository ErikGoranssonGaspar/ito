...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@ito/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "ito-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("ito-assistant-citation") === highlighted) {
      CSS.highlights.delete("ito-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("ito-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "ito-assistant-citation-pulse";
