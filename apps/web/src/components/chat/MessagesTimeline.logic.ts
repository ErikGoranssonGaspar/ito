import { worktreeSetupAgentStarted } from "@ito/client-runtime/worktree-setup";
export { worktreeSetupAgentStarted } from "@ito/client-runtime/worktree-setup";
import * as Equal from "effect/Equal";
import { shallow } from "zustand/vanilla/shallow";
import { renderCodexDirectivesForCopy } from "@ito/client-runtime/codex-markdown-directives";
import { commandProgramName } from "@ito/client-runtime/work-log/command-label";
import {
...
export type MessagesTimelineRow =
  ...
  | {
      ...
      summaryToolIcon?: "browser" | "device" | "ito" | "pull-request";
      hasFailure: boolean;
    }
  | {
      kind: "turn-fold";
