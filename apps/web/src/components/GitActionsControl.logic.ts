import type { GitRunStackedActionResult, GitStackedAction, VcsStatusResult } from "@ito/contracts";
import { isTemporaryWorktreeBranch } from "@ito/shared/git";
import {
...
export { resolveAutoFeatureBranchName } from "@ito/shared/git";
