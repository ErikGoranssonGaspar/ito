...
import { resolveThreadCurrentPullRequestLink } from "@ito/shared/threadPullRequests";
...
import {
  ...
  effectiveSnoozed,
  threadWokeAt,
} from "@ito/client-runtime/state/thread-settled";
import { resolveSettledThreadTimestamp } from "@ito/client-runtime/state/thread-sort";
import type { EnvironmentThreadShell } from "@ito/client-runtime/state/models";
import {
...
const SETTLED_SHELF_EXPANDED_KEY = "ito:sidebar:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "ito:sidebar:snoozed-expanded";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // Plain clicks open Ito; individual PR links also support opening the host in a new tab.
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (Itô, hosted) resolve their
