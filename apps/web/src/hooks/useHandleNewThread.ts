...
import { scopedProjectKey, scopeProjectRef, scopeThreadRef } from "@ito/client-runtime/environment";
import { DEFAULT_SERVER_SETTINGS, type ScopedProjectRef, type ThreadId } from "@ito/contracts";
...
import { resolveDefaultThreadEnvMode } from "@ito/shared/threadEnvMode";
...
import { readItoProjectFileDefaultThreadEnvMode } from "../lib/itoProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The ito.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readItoProjectFileDefaultThreadEnvMode(
