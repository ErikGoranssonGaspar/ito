...
import type { RuntimeMode } from "@ito/contracts";
...
vi.mock("@ito/client-runtime/environment", () => ({
  scopedProjectKey: () => "remote-project",
  scopeProjectRef: (environmentId: string, projectId: string) => ({ environmentId, projectId }),
  scopeThreadRef: (environmentId: string, threadId: string) => ({ environmentId, threadId }),
}));
vi.mock("@ito/contracts", () => ({
  DEFAULT_RUNTIME_MODE: "default",
  DEFAULT_SERVER_SETTINGS: {},
}));
vi.mock("@ito/shared/projectSettings", () => ({
...
vi.mock("@ito/shared/threadEnvMode", () => ({
...
vi.mock("../lib/itoProjectFileDefaults", () => ({
  readItoProjectFileDefaultThreadEnvMode: () => testState.projectFileRead,
}));
vi.mock("../lib/utils", () => ({
