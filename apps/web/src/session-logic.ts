...
} from "@ito/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload } from "@ito/contracts";
import { foldUserInputActivities } from "@ito/client-runtime/work-log/user-input";
import * as Option from "effect/Option";
import * as Schema from "effect/Schema";
import * as Arr from "effect/Array";
import { shallow } from "zustand/vanilla/shallow";
import { isBackgroundTaskActivity } from "@ito/client-runtime/state/subagentRuntime";
import {
...
import { extractToolActivityPresentation } from "@ito/client-runtime/work-log/tool-presentation";
import {
...
export type { PendingApproval, PendingUserInput } from "@ito/client-runtime/pending-requests";

export { formatDuration } from "@ito/shared/orchestrationTiming";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@ito/contracts").ToolActivitySurface;
  toolIcon?: import("@ito/contracts").ToolActivityIcon;
  toolSource?: import("@ito/contracts").ToolActivitySource;
  toolData?: unknown;
