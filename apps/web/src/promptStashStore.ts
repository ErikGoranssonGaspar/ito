import { ComposerContextRecord, ForwardCompatibleArray } from "@ito/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "ito:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "ito:prompt-stash:v1";
