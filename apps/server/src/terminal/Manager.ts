...
import { makeKeyedCoalescingWorker } from "@ito/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@ito/shared/hostProcess";
import { getTerminalLabel } from "@ito/shared/terminalLabels";
...
>()("@ito/server/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("ITO_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_Ito-XXXX/usr/bin, the bundled glib schemas,
