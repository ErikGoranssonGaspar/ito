...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@ito/contracts";
import { VcsUnsupportedOperationError } from "@ito/contracts";
...
>()("@ito/server/vcs/VcsDriverRegistry") {}
