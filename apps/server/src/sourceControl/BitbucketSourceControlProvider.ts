...
import { SourceControlProviderError, type ChangeRequest } from "@ito/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set ITO_BITBUCKET_EMAIL and ITO_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
