...
import { detectSourceControlProviderFromRemoteUrl } from "@ito/shared/sourceControl";
...
} | null>("ito/PullRequestService/routingCredential", { defaultValue: () => null });
...
>()("@ito/server/pullRequest/PullRequestService") {}
