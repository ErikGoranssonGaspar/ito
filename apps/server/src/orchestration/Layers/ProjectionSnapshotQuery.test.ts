    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'pingdotgg/ito',
            41,
            'https://github.com/pingdotgg/ito/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"pingdotgg/ito","number":41,"url":"https://github.com/pingdotgg/ito/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "pingdotgg/ito",
          number: 41,
          url: "https://github.com/pingdotgg/ito/pull/41",
          source: "created",
