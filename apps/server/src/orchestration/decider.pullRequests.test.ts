...
function makeLink(overrides: Partial<ThreadPullRequestLink> = {}): ThreadPullRequestLink {
  return {
    ...
    repository: "ito/ito",
    number: 42,
    url: "https://github.com/ito/ito/pull/42",
    source: "manual",
    linkedAt: NOW,
    snapshot: null,
    stack: null,
  ...
  it.effect("links the same Forgejo number on two ports and unlinks an older portless record", () =>
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        repository: "ito/ito",
        number: 42,
        url: "http://forge.example:4000/ito/ito/pulls/42",
        source: "manual",
      });
  ...
  it.effect("legacy unlink cannot remove a newer cross-host link", () =>
    Effect.gen(function* () {
      ...
      const foreign = makeLink({
        ...
        url: "https://github.enterprise.test/ito/ito/pull/42",
    ...
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        linkedPullRequest: {
          ...
          repository: "ito/ito",
          number: 99,
          url: "https://github.com/ito/ito/pull/99",
        },
      });
