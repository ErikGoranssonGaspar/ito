...
import { nodeRuntimeUnavailableMessage } from "@ito/shared/nodeRuntime";
...
export function agentDeviceQuickStart(
  ...
  return [
    ...
    "For remote hosts, arrange builds, app installation, and any Metro reverse forwarding yourself. Itô provides discovery, streaming, and control only.",
