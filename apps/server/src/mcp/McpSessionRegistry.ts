import { ProviderInstanceId, ThreadId } from "@ito/contracts";
...
>()("@ito/server/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the `ito` toolkits on a remote-reachable server.
 */
