...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@ito/contracts";
...
const owner = "ito-auth-session-owner";
const otherOwner = "ito-auth-session-other";
