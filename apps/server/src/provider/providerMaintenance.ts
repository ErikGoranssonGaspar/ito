...
import { resolveCommandPath } from "@ito/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "ito/providerMaintenance/ProviderVersionCache",
  {
 ...
 * owns that path; anything unproven stays manual-only so Itô never runs
