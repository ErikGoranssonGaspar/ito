import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@ito/contracts";
...
const ITO_CODE_OAUTH_REFERRER = "ito";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: ITO_CODE_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Ito's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
