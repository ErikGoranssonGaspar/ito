          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  ITO_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.ito.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.ito.bearer_token_env_var="ITO_MCP_BEARER_TOKEN"',
                ],
