import { tokenizeCliArgs } from "@ito/shared/cliArgs";

const ITO_CODEX_LAUNCH_ARGS_ENV = "ITO_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[ITO_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
