...
export interface CodexSessionRuntimeOptions {
  ...
  /** Capabilities the session's `ito` MCP credential grants; drives the prompt blocks. */
...
/** Converts a Ito approval decision into the MCP elicitation wire response. */
...
function buildCodexCollaborationMode(input: {
  ...
  readonly browserToolsAvailable?: boolean | ItoToolAvailability;
