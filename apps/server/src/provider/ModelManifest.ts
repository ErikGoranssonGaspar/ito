...
import { codexModelFamily } from "@ito/shared/model";
...
const MODEL_MANIFEST_URL =
  "https://raw.githubusercontent.com/pingdotgg/ito/main/apps/server/src/provider/model-manifest.json";
...
>()("@ito/server/provider/ModelManifest") {}
