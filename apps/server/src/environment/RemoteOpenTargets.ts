 ...
 */
import { type RemoteOpenTarget } from "@ito/contracts";
import { HostProcessHostname } from "@ito/shared/hostProcess";
import * as NetService from "@ito/shared/Net";
import { readTailscaleStatus } from "@ito/tailscale";
...
>()("@ito/server/environment/RemoteOpenTargets") {}
