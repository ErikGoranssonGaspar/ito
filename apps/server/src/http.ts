...
import { isDevProxiedPath } from "@ito/shared/devProxy";
import { decodeOtlpTraceRecords } from "@ito/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["ito://app", "ito-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // ITO_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
