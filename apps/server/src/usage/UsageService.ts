 ...
 * Grok Build) rather than Itô's orchestration projections, so usage covers
 * turns driven outside Itô too. This is the approach `ccusage` takes.
 *
...
import { HostProcessEnvironment } from "@ito/shared/hostProcess";
