...
const DESKTOP_PRODUCTION_SCHEME = "ito";
const DESKTOP_DEVELOPMENT_SCHEME = "ito-dev";
...
>()("@ito/desktop/electron/ElectronProtocol") {}
...
export function makeDesktopContentSecurityPolicy(input: DesktopProtocolRegistrationInput): string {
  ...
  // provider and tool endpoints. Those environment
