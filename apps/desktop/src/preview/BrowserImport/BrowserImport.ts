 ...
 * into an Itô browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@ito/contracts";
...
import { HostProcessExecutablePath } from "@ito/shared/hostProcess";
...
>()("@ito/desktop/preview/BrowserImport/BrowserImport") {}
