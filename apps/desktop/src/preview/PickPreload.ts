...
const OVERLAY_ATTRIBUTE = "data-ito-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--ito-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--ito-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--ito-radius": theme.radius,
    "--ito-background": theme.background,
    "--ito-foreground": theme.foreground,
    "--ito-popover": theme.popover,
    "--ito-popover-foreground": theme.popoverForeground,
    "--ito-primary": theme.primary,
    "--ito-primary-foreground": theme.primaryForeground,
    "--ito-muted": theme.muted,
    "--ito-muted-foreground": theme.mutedForeground,
    "--ito-accent": theme.accent,
    "--ito-accent-foreground": theme.accentForeground,
    "--ito-border": theme.border,
    "--ito-input": theme.input,
    "--ito-ring": theme.ring,
    "--ito-font-sans": theme.fontSans,
    "--ito-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-ito-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--ito-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-ito-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
