import type { DesktopSshPasswordPromptRequest } from "@ito/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@ito/contracts";
import type { SshPasswordRequest } from "@ito/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Itô window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@ito/desktop/ssh/DesktopSshPasswordPrompts") {}
