...
export const make = Effect.gen(function* () {
  ...
  // crypto.randomBytes is a yield point, and concurrent resolves must not
  // generate distinct tokens and overwrite each other.
  ...
  // Observability settings get re-read on each resolve so a hot-swap of the
