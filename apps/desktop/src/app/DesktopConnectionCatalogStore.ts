...
} from "@ito/client-runtime/platform";
import type { PersistedSavedEnvironmentRecord } from "@ito/contracts";
...
>()("@ito/desktop/app/DesktopConnectionCatalogStore") {}
...
> {
  ...
  for (const record of records) {
    // Relay-managed saved environments are no longer supported; drop them
    // rather than migrating them into the catalog.
