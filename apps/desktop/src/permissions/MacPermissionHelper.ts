...
<header>↑ Drag Itô into the list above</header>
<button id="app" draggable="true" aria-label="Drag Itô to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Itô</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Itô icon is missing.");
