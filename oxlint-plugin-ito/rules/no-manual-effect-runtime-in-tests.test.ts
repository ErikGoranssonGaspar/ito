...
const rule = createOxlintRuleHarness("ito/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("ito/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("ito/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("ito/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("ito/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
