...
const rule = createOxlintRuleHarness("ito/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("ito/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Itô";`);
